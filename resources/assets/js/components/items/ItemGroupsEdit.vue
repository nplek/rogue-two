<template>
    <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Edit Item group</div>
            <div class="panel-body">
                <form v-on:submit="saveForm()">
                    <div class="row">
                        <div class="col-xs-12 form-group">
                            <label class="control-label">Short Name</label>
                            <input type="text" v-model="item.short_name" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 form-group">
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get('/api/itemgroups/' + id,{
                ...
                .catch(function () {
                    alert("Could not load your item group")
                });
        },
        data: function () {
            return {
        ...
        methods: {
            ...
            saveForm() {
                ...
                axios.patch('/api/itemgroups/' + app.itemId, newItem,{
                        headers: {
                            'Accept': 'application/json',
                            'Authorization': 'Bearer '+ app.token
                        }
                    ...
                    .catch(function (resp) {
                        ...
                        alert("Could not update your item group");
                    });
            }
        }
    }
