...
class TransferItemController extends Controller
{
    ...
    public function dummyDoc(){
        ...
        $dummy = \GenDocNumber::dummyDocnumber(env('DOC_TFI', 'TFI-NUM'), $department);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $issue->shipdate = date("Y-m-d", strtotime($request['shipdate']));
            $issue->remark = $request['remark'];
            $issue->ref1 = ' ' ;//$request['ref1'];
            $issue->ref2 = $request['towhs_code'];  //to whs
            ...
            $issue->docnum = \GenDocNumber::genDocnumber(env('DOC_TFI', 'TFI-NUM'), $department);
            $issue->save();
