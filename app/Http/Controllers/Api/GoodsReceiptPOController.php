...
class GoodsReceiptPOController extends Controller
{
    ...
    public function dummyDoc(){
        ...
        $dummy = \GenDocNumber::dummyDocnumber('GRP-NUM', $department);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $goodsreceipt->doctype='P';
            $goodsreceipt->cardcode = $request['card_code'];
            ...
            $goodsreceipt->docnum = \GenDocNumber::genDocnumber('GRP-NUM', $department);
            $goodsreceipt->save();
            ...
            if (isset($trans)) {
                foreach ($trans as $value) {
                    ...
                    if ($item != null){ 
                        ...
                        $gitem->itemcode = $item_code;  //
                        $gitem->item_id = $item->id; //
                        $gitem->dscription = $item->dscription; //
                        ...
                        \DB::rollback();
                        return response()->json(['message' => 'Item code [' . $item_code .'] not found. Please contact Admin.'], 500);
                    }
                }
            }
            \DB::commit();
            ...
            DB::rollback();
            throw $e;
            //$result['amessage'] = $e->getMessage();
            //return $result;
            //{"message":"The given data was invalid.","errors":{"project_id":["The project id field is required."]}}
